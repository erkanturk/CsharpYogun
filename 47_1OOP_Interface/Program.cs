        ...
        static void Main(string[] args)
        {
            ...
            /*
                 *Bir sınıftan kalıtımla almak güçlü bir mekanizmadır, asıl kalıtımın gücü bir arayüzden kalıtımla almasında yatar. 
                 ...
                 Aslında soyut sınıflar(abstract class) arayüzlere(interfacelere) 
                 benzerler ancak soyut sınıflar kod ve veri içerebildikleri için arayüzlerden ayrılır. 
                 ...
                 *Arayüz uygulamasının kullanım amacı büyük çaplı ve çok sayıda geliştiricinin 
                 *çalıştığı projelerde belirli kurallar tanımlayıp bu kurallar yardımı ile sınıfların
                 *hangi özellikleri barındırması gerektiğini belirterek geliştiricilere yol göstermektedir. 
                  Küçük çaplı ve bireysel olarak geliştirilen projelerde geliştirici hangi sınıfta 
            hangi metotları kullanması gerektiğini kendisi belirlediği için
                  arayüz kullanmak gerekmemektedir. Büyük projelerde ise yazılım mimarı altında
            çalışan geliştiricilere yol göstermek için arayüz tanımlayabilir.
            ...
            #endregion
            /* Bir arayüzdür bir sınıf değildir bu yapıda gövdesiz methodlar yazarız ve diğer sınıflar bu yapıyı kullanmak zorundadır.
             * Arayüzler genelde ortak özellikleri barındıran Soyut yapılardır Bu yapılarda Yapıcı method Tanımlayamayız.
             * Arayüzlerden Nesne oluşturamayız.
             * Arayüzler bir sınıfa miras verebilirler
             * Arayüzler arayüzlere miras verebilir bu durumda miras alan arayüz hala soyut kaldığı için
             * İmplemente etmek zorunda değildir.
             * Fakat bir sınıf arayüzden miras aldığında bu yapıları kullanmak zorundadır.
             * Bir sınıf birden fazla arayüz miras alabilir fakat sadece bir sınıftan miras alabilir.
             * Interface yapısı mutable inheritance için ortaya çıkmış arabirimlerdir (diamond problem)
